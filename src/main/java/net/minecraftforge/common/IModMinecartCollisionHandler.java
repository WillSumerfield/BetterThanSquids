 ...
 * @author CovertJaguar
 */
public interface IModMinecartCollisionHandler
{
     ...
     */
    void onEntityCollision(ModAbstractMinecart cart, Entity other);
     ...
     */
    AABB getCollisionBox(ModAbstractMinecart cart, Entity other);
     ...
     */
    AABB getMinecartCollisionBox(ModAbstractMinecart cart);
     ...
     */
    AABB getBoundingBox(ModAbstractMinecart cart);
}
